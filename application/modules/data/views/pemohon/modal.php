...
<?php if($verify){ ?>
	<a href="<?= site_url('data/pemohon/verify/'.$record->user_id); ?>" class="btn btn-success btn-block"><b>Sudah TerVerifikasi </b></a>
<?php }else{ ?>
	<a href="<?= site_url('data/pemohon/verify/'.$record->user_id); ?>" class="btn btn-danger btn-block"><b>Belum Terverifikasi</b></a>
<?php } ?>
</div>
<!-- ./box-body -->
