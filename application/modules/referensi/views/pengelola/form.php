							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group <?php echo form_error('pengelola') ? 'has-error' : null; ?>">
										<?php
										echo form_label('Pengelola/Unit Kerja','pengelola');
										$data = array('class'=>'form-control','name'=>'pengelola','id'=>'pengelola','type'=>'text','value'=>set_value('pengelola', $record->pengelola));
								...
								<div class="col-md-12">
									<div class="form-group <?php echo form_error('api') ? 'has-error' : null; ?>">
										<?php
										echo form_label('URL API','api');
										$data = array('class'=>'form-control','name'=>'api','id'=>'api','type'=>'text','value'=>set_value('api', $record->api));
										echo form_input($data);
										echo form_error('api') ? form_error('api', '<p class="help-block">','</p>') : '';
										?>
									</div>
								</div>
							</div>
