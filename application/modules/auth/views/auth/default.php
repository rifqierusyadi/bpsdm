...
<head>
  ...
  <![endif]-->
  <style>.login-page{background-image: url("<?= base_url('asset/dist/img/bg-2.jpeg'); ?>") !important; background-repeat: no-repeat; background-attachment: fixed; background-position: center; background-size: cover;}.login-box-body{background: rgba(255,255,255, 0.8) !important}</style>
</head>
<body class="hold-transition login-page">
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>SIDA</b> KALIBRASI</a>
  </div>
  <!-- /.login-logo -->
